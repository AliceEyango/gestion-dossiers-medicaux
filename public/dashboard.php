...
<!-- Menu latéral -->
<aside class="w-64 bg-white shadow p-6 flex flex-col">
...
<?php if ($page === 'accueil'): ?>
   ...
   <div class="bg-white rounded-xl shadow-xl p-12 max-w-6xl flex flex-col md:flex-row items-center gap-12 mx-auto">
    <img src="/gestion-dossiers-medicaux/assets/patient-login.jpeg" alt="Docteur et patient" class="w-full md:w-2/3 rounded-lg shadow-md">
...
<?php elseif ($page === 'patients'): ?>
   ...
   <div class="flex justify-between items-center mb-6">
    ...
    <div class="space-x-2">
        ...
        <a href="imprimer_liste_patients.php" target="_blank" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded shadow inline-block">
    ...
    <input type="text" id="search" placeholder="Rechercher par nom ou prénom..." class="w-full p-2 mb-4 border rounded shadow-sm">
        ...
        <table class="w-full text-sm text-left table-auto">
            ...
            <tbody id="patientTable">
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="p-2"><?= htmlspecialchars($patientModel->decryptData($p['adresse'])) ?></td>
                    <td class="p-2"><?= htmlspecialchars($patientModel->decryptData($p['telephone'])) ?></td>
                    <td class="p-2"><?= htmlspecialchars($patientModel->decryptData($p['mutuelle'])) ?></td>
                    <td class="p-2 text-center space-x-2">
                        <a href="modifier_patient.php?id=<?= $p['id'] ?>" class="text-yellow-500 hover:text-yellow-600"><i class="fas fa-edit"></i></a>
                        ...
                        <a href="imprimer_patient.php?id=<?= $p['id'] ?>" class="text-blue-500 hover:text-blue-600"><i class="fas fa-file-pdf"></i></a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
